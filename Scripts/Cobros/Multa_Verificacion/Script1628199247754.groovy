...
WebUI.click(findTestObject('Repo_Cobros/MultaVerificación/Page_Sistema de Control Vehicular/a_Multa de Verificacin'))

WebUI.delay(2)

WebUI.setText(findTestObject('Repo_Cobros/MultaVerificación/Page_Sistema de Control Vehicular/input_Placa_vchPlaca'), 'UJZ900A')

CustomKeywords.'com.test.demo.CustomFuncions.clickElement'(findTestObject('Repo_Cobros/MultaVerificación/Page_Sistema de Control Vehicular/button_Buscar'))
